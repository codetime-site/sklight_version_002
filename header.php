...
<head>
    ...
    <meta name="description"
        content="SKlight - профессиональное осветительное оборудование для концертных площадок, театров и event-агентств">
    <meta name="keywords"
        content="осветительное оборудование, профессиональный свет, концертное освещение, театральное освещение">
    ...
    <header class="header" id="header">
        <div class="header__container">
            ...
            <a href="tel:+79991234567" class="header__phone" aria-label="Позвонить нам">
                <svg class="phone-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
